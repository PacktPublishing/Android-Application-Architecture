...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.packt.abuzar.mvvm.MainPresenter mPresenter;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.presenter == variableId) {
            setPresenter((com.packt.abuzar.mvvm.MainPresenter) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setPresenter(@Nullable com.packt.abuzar.mvvm.MainPresenter Presenter) {
        this.mPresenter = Presenter;
    }
    @Nullable
    public com.packt.abuzar.mvvm.MainPresenter getPresenter() {
        return mPresenter;
    }
