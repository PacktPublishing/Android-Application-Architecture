...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    @NonNull
    public final android.widget.ListView projectList;
    // variables
    @Nullable
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.projectList = (android.widget.ListView) bindings[1];
        this.projectList.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        java.util.List<com.packt.abuzar.extractingmodel.ProjectModel> viewModelProjectListings = null;
        com.packt.abuzar.extractingmodel.MainViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                if (viewModel != null) {
                    // read viewModel.projectListings
                    viewModelProjectListings = viewModel.projectListings;
                }
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.packt.abuzar.extractingmodel.BindingUtils.populateProjectList(this.projectList, viewModelProjectListings);
        }
    }
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.packt.abuzar.extractingmodel.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.packt.abuzar.extractingmodel.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
